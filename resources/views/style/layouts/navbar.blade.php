    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item ">
                    <a class="nav-link single" href="{{url('/')}}#whyus_top">{{trans('admin.whyus')}}<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link single" href="{{url('/')}}#courses">{{trans('admin.courses')}}</a>
                </li>


                <li class="nav-item"  >
                    <a class="nav-link single" href="{{url('/')}}#Package">  {{trans('admin.prices')}} </a>
