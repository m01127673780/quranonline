...
<section class="AllCource">
    ...
    <div class="scetionpath-courses">
        ...
        <div class="  container-fluid custom_new " >
            <div class="row">
                ...
                @foreach($courses as $course)
                    <div  class="col-sm-6 col-lg-3 col_allCource">
                        <a   href="{{url('show/course/'.$course->id)}} ">
                            ...
                            <div class="contant">
                                <div class="content">
                                    <div class="card cardhover">
                                        <img src="{{url('/')}}/storage/{{$course->icon}}"class="img-whyus">
                                        
                                        <div class="descriptions ">
                                            <h3 >{{$course['head_'.$lang]}}</h3>
                                            <p class="item-description  " align="justify">

                                                <?php  $str =$course['text_'.$lang] ?>
                                                <?php
                                                $arr = explode("," , $str);
            ...
            <center><a class="btn btn-info" href="{{url('/Allcourses')}}">{{trans('admin.show_all_courses')}}</a></center>
        </div><!--  container -->
    </div><!--  data-n -->
</section><!--./ AllCource   -->
