...
<style>
    ...
    .img_larg_top {
    color: red;
    background: url({{url('default/bg_cources.png')}}) no-repeat center center fixed;
    height:60vh;
    color: #fff;
...
<section class="img_larg_top page_all_cou_rse" >
     <div class="overlay_img_larg_top" style=" ">

    <header class="  " style="background: #f8f9fa;">
        <!--start nav Bar-->
