...
<div class="box">
  ...
  <div class="box-body box-body-student ">
    {!! Form::open(['url'=>aurl('student/'.$student->id),'method'=>'put','files'=>true ]) !!}
       ...
       <div class="form-group">
        ...
        {!! Form::text('name',$student->name,['class'=>'form-control' ,'required'=>'required','required'=>'required']) !!}
     </div>
        <div class="form-group">
        {!! Form::label('email',trans('admin.email')) !!}
        {!! Form::email('email',$student->email,['class'=>'form-control' ,'required'=>'required','required'=>'required']) !!}
     </div>      
       <div class="form-group">
        {!! Form::label('phone',trans('admin.phone')) !!}
        {!! Form::text('phone',$student->phone,['class'=>'form-control' ,'required'=>'required','required'=>'required']) !!}
     </div>
       <div class="row"  >
         <!-- ---============================================--- -->          <!-- ---============================================--- -->  
        ...
        <!-- --------------------------------------------- --> 
         ...
         <!-- ---============================================--- --> <!-- ---============================================--- -->  <!-- ---============================================--- -->          <!-- ---============================================--- -->  
            <center> <h3 class="head-h3"> {!! Form::label('Student1',trans('admin.Student2')) !!}   </h3>  </center>
            <div class="col-lg-6">
   ...
   <!--====================================================-->
    ...
    <label for="exampleFormControlSelect1" class="head-smol">  {{trans('admin.how_aboutus')}} </label>
           ...
           <option value="<?php echo $student->how_aboutus ; ?>"  selected="selected"><?php echo $student->how_aboutus ; ?></option>
          <option value="...............">  ............... </option>
 ...
 <section class="  portfolio  "    >
                <div class="form-group">
    <label for="exampleFormControlSelect1" class="head-smol">  {{trans('admin.timezone')}} </label>
...
<section class="   "  >
 <div class="form-group">
    <label for="exampleFormControlSelect1" class="head-smol">  {{trans('admin.location')}} </label>
...
<!-- <input type="date" id="arrive" class="floatLabel input-date" name="date" value="<?php echo date('Y-m-d'); ?>">-->              
   <div class="form-group">
        ...
        {!! Form::date('date',$student->date,['class'=>'form-control']) !!}
     </div>
      ...
      <option value="<?php echo $student->time ; ?>"  selected="selected"><?php echo $student->time ; ?></option>
          <option value="...............">  ............... </option>
