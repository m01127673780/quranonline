...
<!--   {{--================================================================== --}}
 -->     
  <div class="form-group">
        ...
        {!! Form::text('head_ar',$halfhour->head_ar,['class'=>'form-control','required'=>'required']) !!}
     </div>
     <div class="form-group">
        {!! Form::label('head_en',trans('admin.head_en')) !!}
        {!! Form::text('head_en',$halfhour->head_en,['class'=>'form-control','required'=>'required']) !!}
     </div> 
         <div class="form-group">
     ...
     <div class="form-group">
       ...
       <div class="form-group">
        ...
        {!! Form::text('content_ar',$halfhour->content_ar,['class'=>'form-control','required'=>'required']) !!}
     </div>
     <div class="form-group">
        {!! Form::label('content_en',trans('admin.content_en')) !!}
        {!! Form::text('content_en',$halfhour->content_en,['class'=>'form-control','required'=>'required']) !!}
     </div>
     <div class="form-group">
     ...
     <!-- --------- -->
       ...
       <div class="form-group">
        ...
        {!! Form::text('descount3_ar',$halfhour->descount3_ar,['class'=>'form-control']) !!}
     </div>
       <div class="form-group">
     ...
     <!-- --------- --> 
       ...
       <div class="form-group">
        ...
        {!! Form::text('descount6_ar',$halfhour->descount6_ar,['class'=>'form-control']) !!}
     </div>
       <div class="form-group">
     ...
     <!-- --------- -->     <!-- --------- -->
       ...
       <div class="form-group">
        ...
        {!! Form::text('descount12_ar',$halfhour->descount12_ar,['class'=>'form-control']) !!}
     </div>
       <div class="form-group">
