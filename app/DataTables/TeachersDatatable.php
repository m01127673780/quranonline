...
class TeachersDatatable extends DataTable {
	...
	public function dataTable($query) {
		return datatables($query)
			->addColumn('checkbox', 'admin.teachers.btn.checkbox')
			->addColumn('edit', 'admin.teachers.btn.edit')
			->addColumn('delete', 'admin.teachers.btn.delete')
			->addColumn('image', 'admin.teachers.btn.image')
			->rawColumns([
				'edit',
				'delete',
				'checkbox',
